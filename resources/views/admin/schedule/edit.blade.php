...
<form action="{{ route('schedule.update', $event->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="mb-3 row">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input name="end" value="{{ $event->end }}" type="text" class="form-control datepicker">
        </div>
    </div>
    <div class="mb-3 row">
